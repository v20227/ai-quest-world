...
- Display version: `0.100.07`
- Machine version: `0.100.7`
...
- Increment events:
  ...
  - `COLLAB-SETUP-01` -> `0.100.02`: configured sensitive-file ignores and documented branch/worktree, commit, synchronization, and merge workflow. Commit: the commit containing this release entry.
  ...
  - `WORLD-FOUNDATION-01` -> `0.100.07`: added a versioned Small Camp World State, Gate lifecycle projection, credible building unlocks, cumulative progression totals, return highlights, and restart-safe applied-input persistence. Commit: the commit containing this release entry.
