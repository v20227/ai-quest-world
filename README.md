...
The test command covers the Phase 1 protocol/adapter/observer suite, the Milestone 2 normalized event persistence suite, the deterministic Semantic Engine suite, the Quest lifecycle/outcome suite, and the evidence-bounded progression/anti-abuse suite.
